...
public class SampleTestPage2 extends CommonFunction {

	public SampleTestPage2(WebDriver driver) {
		super(driver);
	}
	...
	public void printSampleXpathDiv() {
		logHtmlReport(LogStatus.INFO,"****SampleTestPage 2****"+getLocalizedLocatorString(xpa1,"COUNTRY"));
	}
	
	String xpa2 = "//span[text()=%s]";
	public void printSampleXpathSpan() {
		logHtmlReport(LogStatus.INFO,"****SampleTestPage 2****"+getLocalizedLocatorString(xpa2,"COUNTRY"));
	}
