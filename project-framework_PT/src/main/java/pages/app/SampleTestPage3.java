...
public class SampleTestPage3 extends CommonFunction {

	public SampleTestPage3(WebDriver driver) {
		super(driver);
	}
	...
	public void printSampleXpathDiv() {
		logHtmlReport(LogStatus.INFO,"****SampleTestPage 3****"+getLocalizedLocatorString(xpa1,"COUNTRY"));
	}
	
	String xpa2 = "//span[text()=%s]";
	public void printSampleXpathSpan() {
		logHtmlReport(LogStatus.INFO,"****SampleTestPage 3****"+getLocalizedLocatorString(xpa2,"COUNTRY"));
	}
